...
//#define NXPROB 64                /* x dimension of problem grid */
//#define NYPROB 80                 /* y dimension of problem grid */
...
int main (int argc, char *argv[]) {
		...
		shared(u, parms) private(it)
	{
		for (it = 1; it <= STEPS; it++) {
			...
			#pragma omp for collapse(2) schedule(static) private (ix, iy, iz)
